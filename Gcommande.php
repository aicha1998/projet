...
<table class="table table-bordered table-striped mb-none"  id="myTable2" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
							<thead>
								<tr>
										<th onclick="sortTable(0)">idCom</th>
										<th onclick="sortTable(1)">nomproduit</th>
										<th>date</th>
										<th onclick="sortTable(3)">EtatCom</th>
...
?>
	...
	<td><?PHP echo $row['dateEmis']; ?></td>
	<td><?PHP echo $row['EtatCom']; ?></td>
	<td><?PHP echo $row['email']; ?></td>
	<td><?PHP echo $row['prix']; ?></td>
    <td>
        <a href="modifierc.php?idCom=<?php echo $row['idCom']?>"><input type="submit" name=""></a>
    </td>
